...
namespace :csv_load_mock do
  ...
  task invoices: :environment do
    CSV.foreach(Rails.root.join('db/mock/invoices.csv'), headers: true, :header_converters => :symbol) do |row|
  ...
  task transactions: :environment do
    CSV.foreach(Rails.root.join('db/mock/transactions.csv'), headers: true, :header_converters => :symbol) do |row|
  ...
  task invoice_items: :environment do
    CSV.foreach(Rails.root.join('db/mock/invoice_items.csv'), headers: true, :header_converters => :symbol) do |row|
