...
namespace :csv_load do
  ...
  task :create_customers => :environment do
    ...
    table = 'customers'
    auto_inc_val = 1001    # New auto increment start point
  ...
  task :create_invoice_items => :environment do
    ...
    table = 'invoice_items'
    auto_inc_val = 4015    # New auto increment start point
    ActiveRecord::Base.connection.execute(
                                          "ALTER SEQUENCE #{table}_id_seq RESTART WITH #{auto_inc_val}"
                                        )
  end
  ...
  task :create_invoices => :environment do
    ...
    table = 'invoices'
    auto_inc_val = 901    # New auto increment start point
    ActiveRecord::Base.connection.execute(
                                          "ALTER SEQUENCE #{table}_id_seq RESTART WITH #{auto_inc_val}"
                                        )
  end
  ...
  task :create_items => :environment do
    ...
    table = 'items'
    auto_inc_val = 2484    # New auto increment start point
    ActiveRecord::Base.connection.execute(
                                          "ALTER SEQUENCE #{table}_id_seq RESTART WITH #{auto_inc_val}"
                                        )
  end
  ...
  task :create_merchants => :environment do
    ...
    table = 'merchants'
    auto_inc_val = 101    # New auto increment start point
    ActiveRecord::Base.connection.execute(
                                          "ALTER SEQUENCE #{table}_id_seq RESTART WITH #{auto_inc_val}"
                                        )
  end
  ...
  task :create_transactions => :environment do
    ...
    table = 'transactions'
    auto_inc_val = 1045    # New auto increment start point
    ActiveRecord::Base.connection.execute(
      "ALTER SEQUENCE #{table}_id_seq RESTART WITH #{auto_inc_val}"
    )
  end
