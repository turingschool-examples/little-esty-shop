...
@invoice_item2 = InvoiceItem.create!(item_id: @item2.id, invoice_id: @invoice2.id, quantity: 2, unit_price: @item1.unit_price, status: "packaged")
@invoice_item3 = InvoiceItem.create!(item_id: @item3.id, invoice_id: @invoice3.id, quantity: 4, unit_price: @item1.unit_price, status: "pending")
@invoice_item4 = InvoiceItem.create!(item_id: @item4.id, invoice_id: @invoice4.id, quantity: 7, unit_price: @item1.unit_price, status: "pending")
@invoice_item5 = InvoiceItem.create!(item_id: @item5.id, invoice_id: @invoice5.id, quantity: 3, unit_price: @item1.unit_price, status: "shipped")
@invoice_item6 = InvoiceItem.create!(item_id: @item6.id, invoice_id: @invoice6.id, quantity: 14, unit_price: @item1.unit_price, status: "packaged")
@invoice_item7 = InvoiceItem.create!(item_id: @item7.id, invoice_id: @invoice7.id, quantity: 13, unit_price: @item1.unit_price, status: "pending")
@invoice_item8 = InvoiceItem.create!(item_id: @item8.id, invoice_id: @invoice8.id, quantity: 54, unit_price: @item1.unit_price, status: "shipped")
@invoice_item9 = InvoiceItem.create!(item_id: @item9.id, invoice_id: @invoice9.id, quantity: 9, unit_price: @item1.unit_price, status: "shipped")
@invoice_item10 = InvoiceItem.create!(item_id: @item10.id, invoice_id: @invoice10.id, quantity: 23, unit_price: @item1.unit_price, status: "shipped")
@invoice_item11 = InvoiceItem.create!(item_id: @item11.id, invoice_id: @invoice11.id, quantity: 2, unit_price: @item1.unit_price, status: "shipped")
@invoice_item12 = InvoiceItem.create!(item_id: @item12.id, invoice_id: @invoice12.id, quantity: 4, unit_price: @item1.unit_price, status: "shipped")
@invoice_item13 = InvoiceItem.create!(item_id: @item13.id, invoice_id: @invoice13.id, quantity: 6, unit_price: @item1.unit_price, status: "packaged")
@invoice_item14 = InvoiceItem.create!(item_id: @item14.id, invoice_id: @invoice14.id, quantity: 8, unit_price: @item1.unit_price, status: "pending")
@invoice_item15 = InvoiceItem.create!(item_id: @item15.id, invoice_id: @invoice15.id, quantity: 9, unit_price: @item1.unit_price, status: "shipped")
@invoice_item16 = InvoiceItem.create!(item_id: @item16.id, invoice_id: @invoice16.id, quantity: 3, unit_price: @item1.unit_price, status: "shipped")
@invoice_item17 = InvoiceItem.create!(item_id: @item17.id, invoice_id: @invoice17.id, quantity: 5, unit_price: @item1.unit_price, status: "packaged")
@invoice_item18 = InvoiceItem.create!(item_id: @item18.id, invoice_id: @invoice18.id, quantity: 6, unit_price: @item1.unit_price, status: "pending")
@invoice_item19 = InvoiceItem.create!(item_id: @item19.id, invoice_id: @invoice19.id, quantity: 3, unit_price: @item1.unit_price, status: "shipped")
@invoice_item20 = InvoiceItem.create!(item_id: @item20.id, invoice_id: @invoice20.id, quantity: 4, unit_price: @item1.unit_price, status: "packaged")
@invoice_item21 = InvoiceItem.create!(item_id: @item21.id, invoice_id: @invoice21.id, quantity: 9, unit_price: @item1.unit_price, status: "shipped")
...
@transaction10 = Transaction.create!(invoice_id: @invoice10.id, credit_card_number: 4654405418249632, credit_card_expiration_date: "", result: "failed")
...
@transaction20 = Transaction.create!(invoice_id: @invoice20.id, credit_card_number: 4654405418249632, credit_card_expiration_date: "", result: "failed")
