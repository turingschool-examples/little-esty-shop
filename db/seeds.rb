...
@invoice12 = Invoice.create!(status: 'completed', customer_id: @customer1.id)
@invoice13 = Invoice.create!(status: 'completed', customer_id: @customer1.id)
@invoice14 = Invoice.create!(status: 'completed', customer_id: @customer1.id)
@invoice15 = Invoice.create!(status: 'completed', customer_id: @customer1.id)
@invoice16 = Invoice.create!(status: 'completed', customer_id: @customer1.id)
@invoice17 = Invoice.create!(status: 'completed', customer_id: @customer1.id)
