class Merchant < ApplicationRecord
  ...
  def top_5_customers
    ...
    successful_invoices = Invoice.joins(:transactions).where(id: invoice_ids).where(transactions: { result: "success" })
    ...
    customers_top_5 = Customer.where(id: customer_ids).to_a
  end
