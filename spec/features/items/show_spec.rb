...
RSpec.describe Item, type: :feature do
  describe 'show page' do
    before :each do
      ...
      @item1 = @merchant1.items.create!(name: 'Item1', description: 'Description1', unit_price: 111, status: "enabled")
      @item11 = @merchant1.items.create!(name: 'Item11', description: 'Description11', unit_price: 1111, status: :enabled)
