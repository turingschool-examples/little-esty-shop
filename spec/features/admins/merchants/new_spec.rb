...
RSpec.describe 'New merchant' do
  ...
  it 'has a form that allows me to add merchant information' do
    expect(page).to have_field(:name)
  end

  describe 'When I fill out the form I click ‘Submit' do
    it 'creates the new merchant and redirects to the admin merchant index' do
      fill_in(:name, with: "Alastair")
      click_on "Submit"
      ...
      within("#disabled") do
        ...
        within("#merchant_#{Merchant.last.id}") do
