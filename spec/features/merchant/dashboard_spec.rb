        ...
        describe 'Merchant Bulk Discounts Index' do
          it 'I see a link to view all my discounts' do
            ...
            # within("#ind-discount-#{@discount_2.id}") do
              expect(page).to have_content("Discount Percentage: #{@discount_2.discount_percentage}")
            ...
            # within("#discount-info-#{@discount_3.id}") do
              expect(page).to have_content("Discount Percentage: #{@discount_3.discount_percentage}")
              expect(page).to have_content("Quantity Threshold: #{@discount_3.quantity_threshold}")
              expect(page).to have_link("Discount #{@discount_3.id}")
            # end
          end
        end
      end
