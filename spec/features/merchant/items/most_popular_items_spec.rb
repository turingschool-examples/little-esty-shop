...
RSpec.describe "When I visit '/merchant/merchant_id/items'" do
  before :each do
    ...
    @invoice_item1 = create(:invoice_item, invoice_id: @invoice1.id, item_id: @item1.id, status: 2, quantity: 1, unit_price: 100)
    @invoice_item2 = create(:invoice_item, invoice_id: @invoice2.id, item_id: @item2.id, status: 2, quantity: 1, unit_price: 100)
    @invoice_item3 = create(:invoice_item, invoice_id: @invoice3.id, item_id: @item3.id, status: 2, quantity: 1, unit_price: 100)
    @invoice_item4 = create(:invoice_item, invoice_id: @invoice4.id, item_id: @item4.id, status: 2, quantity: 1, unit_price: 100)
    @invoice_item5 = create(:invoice_item, invoice_id: @invoice5.id, item_id: @item5.id, status: 2, quantity: 1, unit_price: 100)
    ...
    @invoice_item9 = create(:invoice_item, invoice_id: @invoice3.id, item_id: @item6.id, status: 2, quantity: 1, unit_price: 100)
    @invoice_item10 = create(:invoice_item, invoice_id: @invoice4.id, item_id: @item6.id, status: 2, quantity: 1, unit_price: 100)
    @invoice_item11 = create(:invoice_item, invoice_id: @invoice5.id, item_id: @item6.id, status: 2, quantity: 1, unit_price: 100)
    @invoice_item12 = create(:invoice_item, invoice_id: @invoice6.id, item_id: @item6.id, status: 2, quantity: 1, unit_price: 100)
  ...
  describe "I see the names of top 5 most popular items by total revenue" do
    ...
    it "I see total revenue generated next to each item name"
  end
end
