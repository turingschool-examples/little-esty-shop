      ...
      describe 'Then I see the names of the top 5 most popular items ranked by total revenue generated' do
        describe 'And I see that each item name links to my merchant item show page for that item' do
          it 'And I see the total revenue generated next to each item name' do
            ...
            invoice_item1 = InvoiceItem.create!(invoice_id: invoice2.id, item_id: item_bike.id, quantity: 900, unit_price: 10)
            invoice_item1 = InvoiceItem.create!(invoice_id: invoice3.id, item_id: item_climbing_shoes.id, quantity: 800, unit_price: 10)
            invoice_item1 = InvoiceItem.create!(invoice_id: invoice4.id, item_id: item_snowboard.id, quantity: 700, unit_price: 10)
            invoice_item1 = InvoiceItem.create!(invoice_id: invoice5.id, item_id: item_rock.id, quantity: 600, unit_price: 10)
            invoice_item1 = InvoiceItem.create!(invoice_id: invoice6.id, item_id: item_lamp.id, quantity: 500, unit_price: 10)
