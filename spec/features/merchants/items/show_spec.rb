...
RSpec.describe 'Merchant Items show page', type: :feature do
  ...
  it "can see all the items attributes including name, description, and selling price" do
    ...
    within "/merchant/#{@merchant2.id}/items/#{@item5.id}"
