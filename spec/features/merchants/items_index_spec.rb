...
RSpec.describe 'Merchant Items index page' do
 ...
 it "can show the top five_items_best_day" do
    ...
    visit merchant_items_path(mer_1)
      within("#topitems-") do
        expect(page).to have_content("Top day for #{item_1.name} was #{invoice1.created_at.strftime("%m/%d/%Y")}")
        expect(page).to have_content("Top day for #{item_2.name} was #{invoice3.created_at.strftime("%m/%d/%Y")}")
        expect(page).to have_content("Top day for #{item_4.name} was #{invoice4.created_at.strftime("%m/%d/%Y")}")
        expect(page).to have_content("Top day for #{item_5.name} was #{invoice5.created_at.strftime("%m/%d/%Y")}")
        expect(page).to have_content("Top day for #{item_6.name} was #{invoice6.created_at.strftime("%m/%d/%Y")}")
      end
