...
RSpec.describe "Merchant_Invoices#Show", type: :feature do
  before(:each) do
    ...
    @invoice_item_2 = create(:invoice_item, item: @item_2, invoice: @invoice_1, quantity: 1, status: "packaged", created_at: Date.new(2023,1,2))
    @invoice_item_3 = create(:invoice_item, item: @item_3, invoice: @invoice_1, quantity: 1, status: "packaged", created_at: Date.new(2023,1,3))
    @invoice_item_4 = create(:invoice_item, item: @item_4, invoice: @invoice_1, quantity: 1, status: "packaged", created_at: Date.new(2023,1,4))
    @invoice_item_5 = create(:invoice_item, item: @item_5, invoice: @invoice_1, quantity: 1, status: "packaged", created_at: Date.new(2023,1,5))
    @invoice_item_6 = create(:invoice_item, item: @item_6, invoice: @invoice_2, quantity: 1, status: "packaged", created_at: Date.new(2023,1,6))
