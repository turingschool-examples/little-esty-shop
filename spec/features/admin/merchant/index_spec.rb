...
RSpec.describe "As a admin user" do
  describe 'When I visit an admin merchant show page' do
    ...
    it "I see the names of the top 5 merchants by total revenue generated that are links to their show page" do
      ...
      expect(page).to have_content("Merchant Name: All Birds 1950.0")
      expect(page).to have_content("Merchant Name: Big Lots 1267.5")
      expect(page).to have_content("Merchant Name: Walmart 487.5")
      expect(page).to have_content("Merchant Name: Overstock 292.5")
      expect(page).to have_content("Merchant Name: Alibaba 155.0")
