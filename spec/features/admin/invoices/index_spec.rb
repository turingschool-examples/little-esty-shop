...
RSpec.describe 'admin invoices index page (/admin/invoices)' do
  describe 'as an admin' do
    describe 'when I visit the admin invoices index' do
      ...
      it '- shows a list of all invoice ids in the system' do
        ...
        expect(page).to have_content("Invoice ##{@invoice_13.id}")
        expect(page).to have_content("Invoice ##{@invoice_14.id}")
        expect(page).to have_content("Invoice ##{@invoice_15.id}")
        expect(page).to have_content("Invoice ##{@invoice_16.id}")
        expect(page).to have_content("Invoice ##{@invoice_17.id}")
        expect(page).to have_content("Invoice ##{@invoice_18.id}")
        expect(page).to have_content("Invoice ##{@invoice_19.id}")
        expect(page).to have_content("Invoice ##{@invoice_20.id}")
        expect(page).to have_content("Invoice ##{@invoice_21.id}")
        expect(page).to have_content("Invoice ##{@invoice_22.id}")
      end
