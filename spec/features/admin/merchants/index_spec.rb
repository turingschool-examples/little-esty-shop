...
RSpec.describe 'Admin Merchant Index' do
  ...
  describe 'Admin Merchant Index' do
    it 'displays the name of all merchants in the system', :vcr do
    ...
    it 'displays the top 5 merchants by revenue', :vcr do
      ...
      InvoiceItem.create!(item_id: @item1.id, invoice_id: @invoice1.id, quantity: 1, unit_price: 10_000,
                          status: 0)
      InvoiceItem.create!(item_id: @item2.id, invoice_id: @invoice2.id, quantity: 2, unit_price: 10_000,
                          status: 1)
      InvoiceItem.create!(item_id: @item3.id, invoice_id: @invoice1.id, quantity: 3, unit_price: 10_000,
                          status: 1)
      InvoiceItem.create!(item_id: @item4.id, invoice_id: @invoice2.id, quantity: 4, unit_price: 10_000,
                          status: 2)
      InvoiceItem.create!(item_id: @item5.id, invoice_id: @invoice1.id, quantity: 5, unit_price: 10_000,
                          status: 0)
      InvoiceItem.create!(item_id: @item6.id, invoice_id: @invoice2.id, quantity: 6, unit_price: 10_000,
                          status: 2)
      InvoiceItem.create!(item_id: @item7.id, invoice_id: @invoice1.id, quantity: 1, unit_price: 500, status: 2)
      InvoiceItem.create!(item_id: @item8.id, invoice_id: @invoice3.id, quantity: 1000, unit_price: 10_000,
                          status: 2)
      InvoiceItem.create!(item_id: @item9.id, invoice_id: @invoice1.id, quantity: 10, unit_price: 20_000,
                          status: 2)
      ...
      within '#top-5-merchants' do
        ...
        expect(page).to have_content(210_000)
    ...
    it 'can create a new merchant and show its status', :vcr do
      visit '/admin/merchants'
    ...
    it 'shows the enabled and disabled merchants', :vcr do
      visit '/admin/merchants'
    ...
    it 'has a button to enable/diable mechant next to each name', :vcr do
      visit '/admin/merchants'
    ...
    it 'shows the date with the most revenue next to each of the top 5 merchants', :vcr do
      @merch5 = Merchant.create!(name: 'Rawnald')
      @merch6 = Merchant.create!(name: 'Zombies R Us')
      @merch7 = Merchant.create!(name: 'We are Coffee')
      @merch8 = Merchant.create!(name: 'Hannah French Montanna')
      ...
      InvoiceItem.create!(item_id: @item8.id, invoice_id: @invoice3.id, quantity: 1000, unit_price: 10_000,
                          status: 2)
      InvoiceItem.create!(item_id: @item9.id, invoice_id: @invoice1.id, quantity: 10, unit_price: 20_000, status: 2)
      # As an admin,
