...
RSpec.describe "Admin Dashboard" do
   before :each do
      ...
      @transaction_26 = Transaction.create!(credit_card_number: 1234567890123456, credit_card_expiration_date: "2024-01-01", result: true, invoice: @invoice_26)
      @transaction_27 = Transaction.create!(credit_card_number: 1234567890123456, credit_card_expiration_date: "2024-01-01", result: true, invoice: @invoice_27)
      @transaction_28 = Transaction.create!(credit_card_number: 1234567890123456, credit_card_expiration_date: "2024-01-01", result: true, invoice: @invoice_28)
    end
