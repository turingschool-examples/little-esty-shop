...
RSpec.describe 'Admin Dashboard Page', type: :feature do
    ...
    let!(:invoice1) { joey.invoices.create!(status: 2, created_at: "2021-09-1 08:44:13 UTC") }
    let!(:invoice2) { joey.invoices.create!(status: 1, created_at: "2022-08-2 08:44:13 UTC") }
    let!(:invoice3) { joey.invoices.create!(status: 0, created_at: "2022-09-5 08:44:13 UTC") }
    let!(:invoice4) { joey.invoices.create!(status: 2, created_at: "2022-09-8 08:44:13 UTC") }
