...
##I want to test for a larger amount of customers so i can find the top 5
##this will require a AR method that has a .where clause for successful transactions only *** Model test ***
