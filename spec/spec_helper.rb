...
def test_data
  ...
  @invoice_item_21 = @invoice_1.invoice_items.create!(item: @item_3, quantity: 1, unit_price: 100, status: 1)
  @invoice_item_22 = @invoice_2.invoice_items.create!(item: @item_3, quantity: 1, unit_price: 100, status: 1)
  @invoice_item_23 = @invoice_3.invoice_items.create!(item: @item_3, quantity: 1, unit_price: 100, status: 1)
  @invoice_item_24 = @invoice_4.invoice_items.create!(item: @item_3, quantity: 1, unit_price: 100, status: 1)
  @invoice_item_25 = @invoice_5.invoice_items.create!(item: @item_3, quantity: 1, unit_price: 100, status: 1)
  @invoice_item_26 = @invoice_6.invoice_items.create!(item: @item_3, quantity: 1, unit_price: 100, status: 1)
  @invoice_item_27 = @invoice_7.invoice_items.create!(item: @item_5, quantity: 1, unit_price: 250, status: 1)
  @invoice_item_28 = @invoice_8.invoice_items.create!(item: @item_5, quantity: 1, unit_price: 250, status: 1)
  @invoice_item_29 = @invoice_9.invoice_items.create!(item: @item_5, quantity: 1, unit_price: 250, status: 1)
  @invoice_item_30 = @invoice_10.invoice_items.create!(item: @item_5, quantity: 1, unit_price: 250, status: 1)
  @invoice_item_31 = @invoice_11.invoice_items.create!(item: @item_5, quantity: 1, unit_price: 250, status: 1)
