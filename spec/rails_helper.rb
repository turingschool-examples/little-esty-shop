...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    @trans_2 = create(:transaction, result: 0, invoice: @invoice_1)
    @trans_3 = create(:transaction, result: 0, invoice: @invoice_1)
    @trans_4 = create(:transaction, result: 0, invoice: @invoice_2)
    @trans_5 = create(:transaction, result: 0, invoice: @invoice_2)
    @trans_6 = create(:transaction, result: 0, invoice: @invoice_2)
    @trans_7 = create(:transaction, result: 1, invoice: @invoice_2)
    @trans_8 = create(:transaction, result: 0, invoice: @invoice_3)
    @trans_9 = create(:transaction, result: 1, invoice: @invoice_3)
    @trans_10 = create(:transaction, result: 1, invoice: @invoice_4)
    @trans_11 = create(:transaction, result: 0, invoice: @invoice_5)
    @trans_12 = create(:transaction, result: 0, invoice: @invoice_5)
    @trans_13 = create(:transaction, result: 1, invoice: @invoice_5)
    @trans_14 = create(:transaction, result: 0, invoice: @invoice_6)
  end
end
