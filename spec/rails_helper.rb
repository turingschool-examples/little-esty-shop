...
RSpec.configure do |config|
  config.before(:each) do
    ...
    @invoice_4.invoice_items.create!(item_id: @item_4.id, quantity: 4, unit_price: @item_4.unit_price, status: 0)
    @invoice_5.invoice_items.create!(item_id: @item_5.id, quantity: 5, unit_price: @item_5.unit_price, status: 1)
    @invoice_6.invoice_items.create!(item_id: @item_6.id, quantity: 6, unit_price: @item_6.unit_price, status: 1)
    @invoice_7.invoice_items.create!(item_id: @item_7.id, quantity: 7, unit_price: @item_7.unit_price, status: 1)
    ...
    @invoice_10.invoice_items.create!(item_id: @item_10.id, quantity: 10, unit_price: @item_10.unit_price, status: 1)
    @invoice_11.invoice_items.create!(item_id: @item_1.id, quantity: 1, unit_price: @item_1.unit_price, status: 1)
    @invoice_12.invoice_items.create!(item_id: @item_2.id, quantity: 12, unit_price: @item_2.unit_price, status: 1)
