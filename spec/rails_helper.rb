...
RSpec.configure do |config|
  config.before(:each) do
    ...
    #invoice items
    @invoice_1.invoice_items.create!(item_id: @item_1.id, quantity: 1, unit_price: @item_1.unit_price, status: 1)
    @invoice_2.invoice_items.create!(item_id: @item_2.id, quantity: 2, unit_price: @item_2.unit_price, status: 1)
    @invoice_3.invoice_items.create!(item_id: @item_3.id, quantity: 3, unit_price: @item_3.unit_price, status: 1)
    @invoice_4.invoice_items.create!(item_id: @item_4.id, quantity: 4, unit_price: @item_4.unit_price, status: 1)
    @invoice_5.invoice_items.create!(item_id: @item_5.id, quantity: 5, unit_price: @item_5.unit_price, status: 2)
    @invoice_6.invoice_items.create!(item_id: @item_6.id, quantity: 6, unit_price: @item_6.unit_price, status: 2)
    @invoice_7.invoice_items.create!(item_id: @item_7.id, quantity: 7, unit_price: @item_7.unit_price, status: 2)
    @invoice_8.invoice_items.create!(item_id: @item_8.id, quantity: 8, unit_price: @item_8.unit_price, status: 2)
    @invoice_9.invoice_items.create!(item_id: @item_9.id, quantity: 9, unit_price: @item_9.unit_price, status: 2)
    @invoice_10.invoice_items.create!(item_id: @item_10.id, quantity: 10, unit_price: @item_10.unit_price, status: 2)
    @invoice_11.invoice_items.create!(item_id: @item_1.id, quantity: 1, unit_price: @item_1.unit_price, status: 2)
    @invoice_12.invoice_items.create!(item_id: @item_2.id, quantity: 12, unit_price: @item_1.unit_price, status: 2)
    @invoice_13.invoice_items.create!(item_id: @item_3.id, quantity: 13, unit_price: @item_2.unit_price, status: 2)
    @invoice_14.invoice_items.create!(item_id: @item_4.id, quantity: 14, unit_price: @item_7.unit_price, status: 2)
    @invoice_15.invoice_items.create!(item_id: @item_5.id, quantity: 15, unit_price: @item_8.unit_price, status: 2)
    @invoice_16.invoice_items.create!(item_id: @item_6.id, quantity: 16, unit_price: @item_9.unit_price, status: 3)
    @invoice_17.invoice_items.create!(item_id: @item_7.id, quantity: 17, unit_price: @item_2.unit_price, status: 3)
    @invoice_18.invoice_items.create!(item_id: @item_8.id, quantity: 18, unit_price: @item_3.unit_price, status: 3)
    #transaction
