def test_data
  ...
  @merchant_7 = Merchant.create!(name: "Seventh Merchant")
  @merchant_8 = Merchant.create!(name: "Eighth Merchant")
  @merchant_9 = Merchant.create!(name: "Ninth Merchant")
  @merchant_10 = Merchant.create!(name: "Tenth Merchant")
  ...
  @item_6 = Item.create!(name: "Crack", description: "Description_6", unit_price: 50000, merchant: @merchant_6)
  @item_7 = Item.create!(name: "Ecstasy", description: "Description_7", unit_price: 10000, merchant: @merchant_7)
  @item_8 = Item.create!(name: "Marijuana", description: "Description_8", unit_price: 100000, merchant: @merchant_8)
  @item_9 = Item.create!(name: "Shrooms", description: "Description_9", unit_price: 56465, merchant: @merchant_9)
  @item_10 = Item.create!(name: "Opium", description: "Description_10", unit_price: 54134, merchant: @merchant_10)
