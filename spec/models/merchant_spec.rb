    ...
    describe '#invoice_items_to_ship' do
      describe 'returns an array of invoice_items' do
        ...
        it "ordered by invoice created_at, NOT invoice_item created_at" do
          ...
          expect(@merchant_1.invoice_items_to_ship.to_a).to eq([@customer_1_invoice_1_item_1_pachaged, customer_1_invoice_1, @customer_2_invoice_1_item_1_packaged])
>>>>>>> main
        end
      end
    end
...
<<<<<<< HEAD
  ...
  describe("class method") do
    ...
    it("can check top 5 merchants") do
      ...
      expect(Merchant.top_five_merchants).to(eq([@merchant5, @merchant4, @merchant3, @merchant2, @merchant1]))
    end
  end
end
=======
