...
RSpec.describe Merchant, type: :model do
  ...
  #   @invoice12 = Invoice.create!(status: 0, customer_id: @sally.id, merchant_id: @amazon.id)
  ...
  #   @tx12     = Transaction.create!(credit_card_number: 0100010055, credit_card_expiration_date: 20220101, invoice_id: @invoice12.id,)
