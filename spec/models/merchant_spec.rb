...
RSpec.describe Merchant do
  ...
  before(:each) do
    ...
    @invoice_4 = @customer_5.invoices.create!(status: 1, created_at: '2012-03-26 01:54:09')
    @invoice_5 = @customer_1.invoices.create!(status: 1, created_at: '2012-03-28 12:54:09')
    @invoice_6 = @customer_4.invoices.create!(status: 1)
    ...
    @invoice_12 = @customer_6.invoices.create!(status: 1)
    ...
    @invoice_item_3 = InvoiceItem.create!(item_id: @item_3.id, invoice_id: @invoice_3.id, unit_price: 1500, quantity: 3, status: 0)
    @invoice_item_4 = InvoiceItem.create!(item_id: @item_4.id, invoice_id: @invoice_4.id, unit_price: 1000, quantity: 4, status: 1)
    @invoice_item_5 = InvoiceItem.create!(item_id: @item_5.id, invoice_id: @invoice_5.id, unit_price: 800, quantity: 1, status: 1)
    @invoice_item_6 = InvoiceItem.create!(item_id: @item_6.id, invoice_id: @invoice_6.id, unit_price: 1500, quantity: 1, status: 2)
    @invoice_item_7 = InvoiceItem.create!(item_id: @item_7.id, invoice_id: @invoice_7.id, unit_price: 400, quantity: 36, status: 2)
    @invoice_item_8 = InvoiceItem.create!(item_id: @item_8.id, invoice_id: @invoice_8.id, unit_price: 500, quantity: 1, status: 2)
    @invoice_item_9 = InvoiceItem.create!(item_id: @item_9.id, invoice_id: @invoice_9.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_10 = InvoiceItem.create!(item_id: @item_10.id, invoice_id: @invoice_10.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_11 = InvoiceItem.create!(item_id: @item_11.id, invoice_id: @invoice_11.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_12 = InvoiceItem.create!(item_id: @item_12.id, invoice_id: @invoice_12.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_13 = InvoiceItem.create!(item_id: @item_13.id, invoice_id: @invoice_13.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_14 = InvoiceItem.create!(item_id: @item_14.id, invoice_id: @invoice_14.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_15 = InvoiceItem.create!(item_id: @item_15.id, invoice_id: @invoice_15.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_16 = InvoiceItem.create!(item_id: @item_16.id, invoice_id: @invoice_16.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_17 = InvoiceItem.create!(item_id: @item_17.id, invoice_id: @invoice_17.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_18 = InvoiceItem.create!(item_id: @item_18.id, invoice_id: @invoice_18.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_19 = InvoiceItem.create!(item_id: @item_19.id, invoice_id: @invoice_19.id, unit_price: 100, quantity: 1, status: 2)
    @invoice_item_20 = InvoiceItem.create!(item_id: @item_20.id, invoice_id: @invoice_20.id, unit_price: 100, quantity: 1, status: 2)
    ...
    @transaction_11 = @invoice_11.transactions.create!(result: 'failed')
    @transaction_12 = @invoice_12.transactions.create!(result: 'failed')
  ...
  describe 'class methods' do
    describe '::top_five' do
      it 'lists the top five merchants ordered by total revenue' do
        expect(Merchant.top_five).to eq([merchant_5, merchant_2, merchant_6, merchant_4, merchant_3])
      end
    end
  end
end
