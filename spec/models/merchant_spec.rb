  ...
  describe 'instance methods' do
    ...
    describe '#unshipped_items' do
      it 'returns a collection of unshipped items' do 
        ...
        expect(@merchant_1.unshipped_items).to eq([@item_1, @item_2, @item_3, @item_4, @item_5, @item_8, @item_9])
        expect(@merchant_1.unshipped_items).to_not eq([@item_6, @item_7, @item_10])
      end
    end
  end
end
