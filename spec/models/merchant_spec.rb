...
RSpec.describe Merchant do
    ...
    describe "instance methods" do
        before :each do
            ...
            InvoiceItem.create!(item_id: @item7.id, invoice_id: @invoice1.id, quantity: 10, unit_price: 50000, status: 2)
        ...
        it "list the top 5 items by revenue per a specific merchant" do
            exepct(@merch1.top_five_items_by_revenue).to eq([@item8, @item6, @item5, @item4, @item3])
        end
