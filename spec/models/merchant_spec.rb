  ...
  describe("class method") do
    ...
    it("can check top 5 merchants") do
      before(:each) do
        ...
        @itme11 = @merchant4.items.create!(        name: "K",         description: "Kilo",         unit_price: 11)
        ...
        @itme14 = @merchant5.items.create!(        name: "N",         description: "November",         unit_price: 14)
        ...
        @itme17 = @merchant6.items.create!(        name: "Q",         description: "Quebec",         unit_price: 17)
