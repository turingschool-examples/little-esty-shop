  ...
  describe 'methods' do
    describe '#top_5_customers' do
      it "returns the 5 customers with the largest number of successful transactions for a merchant" do
        ...
        7amada = Customer.create!(first_name: "7amada", last_name: "Hilal")
        ...
        invoice_7 = Invoice.create!(status: 2, customer_id: 7amada.id)
        invoice_8 = Invoice.create!(status: 2, customer_id: 7amada.id)
        ...
        transaction_1 = Transaction.create!(result: 1, invoice_id: invoice_1.id, credit_card_number: 00000001)
        transaction_2 = Transaction.create!(result: 1, invoice_id: invoice_2.id, credit_card_number: 00000002)
        transaction_3 = Transaction.create!(result: 1, invoice_id: invoice_3.id, credit_card_number: 00000003)
        transaction_4 = Transaction.create!(result: 1, invoice_id: invoice_4.id, credit_card_number: 00000004)
        transaction_5 = Transaction.create!(result: 1, invoice_id: invoice_5.id, credit_card_number: 00000005)
        transaction_6 = Transaction.create!(result: 1, invoice_id: invoice_6.id, credit_card_number: 00000006)
        transaction_7 = Transaction.create!(result: 1, invoice_id: invoice_7.id, credit_card_number: 00000007)
        transaction_8 = Transaction.create!(result: 1, invoice_id: invoice_8.id, credit_card_number: 00000008)
        transaction_9 = Transaction.create!(result: 1, invoice_id: invoice_9.id, credit_card_number: 00000009)
        transaction_10 = Transaction.create!(result: 1, invoice_id: invoice_10.id, credit_card_number: 00000010)
        transaction_11 = Transaction.create!(result: 1, invoice_id: invoice_11.id, credit_card_number: 00000011)
        transaction_12 = Transaction.create!(result: 1, invoice_id: invoice_12.id, credit_card_number: 00000012)
        transaction_13 = Transaction.create!(result: 1, invoice_id: invoice_13.id, credit_card_number: 00000013)
        transaction_14 = Transaction.create!(result: 1, invoice_id: invoice_14.id, credit_card_number: 00000014)

        expect(crystal_moon.top_5_customers.length).to eq(5)
        expect(crystal_moon.top_5_customers).to include(paul, sam, abbas, 7amada, frodo)
      end
    end
  end
end