...
RSpec.describe Merchant, type: :model do
  ...
  before(:each) do
    ...
    @invitem1 = create(:invoice_item, invoice: @invoice1, status:'packaged', item: @item1)
    @invitem2 = create(:invoice_item, invoice: @invoice2, status:'packaged',item: @item2)
    @invitem3 = create(:invoice_item, invoice: @invoice3, status:'packaged',item: @item3)
    @invitem4 = create(:invoice_item, invoice: @invoice4, status:'pending', item: @item4)
    @invitem5 = create(:invoice_item, invoice: @invoice5, status:'pending',item: @item5)
    @invitem6 = create(:invoice_item, invoice: @invoice6, status:'shipped', item: @item6)
    ...
    @transaction4 = create(:transaction, result: 'success', invoice: @invoice2)
    @transaction5 = create(:transaction, result: 'success', invoice: @invoice3)
    @transaction6 = create(:transaction, result: 'success', invoice: @invoice3)
    @transaction7 = create(:transaction, result: 'success', invoice: @invoice4)
    @transaction8 = create(:transaction, result: 'success', invoice: @invoice4)
    @transaction9 = create(:transaction, result: 'success', invoice: @invoice5)
    @transaction10 = create(:transaction, result: 'success', invoice: @invoice5)
  end
