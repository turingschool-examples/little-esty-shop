...
RSpec.describe(Merchant, type: :model) do
  ...
  describe("model method") do
    ...
    xit 'top_5_revenue' do
      #here we will need to create fake data with the ensuing requirements:
        #7+ merchants
        #5+ items, each belonging to a single merchant
        #x invoice items per item, allowing calculation of a revenue
