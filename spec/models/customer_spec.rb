...
RSpec.describe Customer, type: :model do
  ...
  describe 'class methods' do 
    before :each do 
      ...
      @invoice_19 = @customer_2.invoices.create!(status: 'in progress')
    ...
    describe '#top_customers' do 
      it 'displays the top 5 customers with the highest successful transactions' do 
        ...
        expect(@merchant_1.customers.top_customers).to eq([@customer_3, @customer_4, @customer_2, @customer_5, @customer_6])
      end
    end
  end
end
