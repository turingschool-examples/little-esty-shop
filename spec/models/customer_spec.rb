...
RSpec.describe Customer do
    ...
    describe "instance methods" do
        ...
        it "gives me the count of successful transactions for a customer" do
          expect(@cust1.successful_transaction_count).to eq(3)
          expect(@cust2.successful_transaction_count).to eq(3)
          expect(@cust3.successful_transaction_count).to eq(3)
          expect(@cust4.successful_transaction_count).to eq(3)
          expect(@cust5.successful_transaction_count).to eq(5)
          expect(@cust6.successful_transaction_count).to eq(0)
          expect(@cust7.successful_transaction_count).to eq(1)
        end
      end
