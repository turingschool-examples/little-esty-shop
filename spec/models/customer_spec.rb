  ...
  describe 'class methods' do
    ...
    describe 'instance methods' do
      it 'shows number of sucessful transactions' do
        ...
        expect(customer_1.sucessful_transactions_count).to eq(2)
        expect(customer_2.sucessful_transactions_count).to eq(1)
        expect(customer_3.sucessful_transactions_count).to eq(1)
        expect(customer_4.sucessful_transactions_count).to eq(1)
        expect(customer_5.sucessful_transactions_count).to eq(1)
      end
    end
  end
end
