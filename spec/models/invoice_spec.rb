...
describe Invoice do
    before :each do
        ...
        invoice_item4 = create(:invoice_item, item_id:@item_4.id, invoice_id:@invoice4.id, quantity: 3, unit_price: 5, status: 0)
        invoice_item4 = create(:invoice_item, item_id:@item_5.id, invoice_id:@invoice6.id, quantity: 3, unit_price: 5, status: 0)
        invoice_item4 = create(:invoice_item, item_id:@item_6.id, invoice_id:@invoice5.id, quantity: 3, unit_price: 5, status: 0)
  ...
  describe "class methods" do
    ...
    it "#incomplete_invoices" do
        ...
        expect(Invoice.incomplete_invoices.first.id).to eq(@invoice4.id)
    end
  end
end
