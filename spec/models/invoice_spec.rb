...
RSpec.describe Invoice do
  ...
  describe 'instance methods' do
    it 'returns the date in words-ish' do
      ...
      invoice_1 = Invoice.create(id: 1, customer_id: customer_1.id, status: 'cancelled', created_at: "2012-03-27 14:54:09 UTC")

      expect(invoice_1.formatted_date).to eq("Tuesday, March 27, 2012")
    end
