...
RSpec.describe Invoice do
  ...
  let!(:invoice_2) {customer_1.invoices.create!(status: 1, created_at: '2012-03-25 09:54:09')}
  let!(:invoice_3) {customer_1.invoices.create!(status: 1, created_at: '2012-03-25 09:54:09')}
