...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe 'methods' do
    ...
    describe '#self.not_shipped' do
      it 'returns an array of all invoice items that have not been shipped yet' do
        expect(InvoiceItem.not_shipped).to include(@pearl_invoice, @moon_rock_invoice, @topaz_invoice, @lapis_lazuli_invoice, @zinc_invoice, @surf_board_invoice)
